import type { Concat, Drop } from 'typescript-tuple';
...
export type BasicTypeRecord<EventList extends BasicEventList> =
...
> = DefaultEventCallbackParams extends any[]
  ? GetTypesForEntry<Event, TypeRecord> extends any[]
    ? Concat<
        Exclude<DefaultEventCallbackParams, undefined>,
        Exclude<GetTypesForEntry<Event, TypeRecord>, undefined>
      >
...
export type AllToUndefined<T extends any[]> = T['length'] extends 1
  ? [T[0] | undefined]
  : [T[0] | undefined, ...AllToUndefined<Drop<T, 1>>];
