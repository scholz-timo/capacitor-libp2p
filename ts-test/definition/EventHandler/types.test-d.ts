...
import { EventParameters, GetTypesForEntry, ReverseMap, UnionToArray } from '../../../src/definition/EventListener/types';
...
type ForExampleEnumEntryTypes = GetTypesForEntry<ExampleEnum.HELLO, ReversedExampleEnum>;
...
expectType<["test2"]>(callbackGenerator<EventParameters<ReversedExampleEnum, ExampleEnum.HELLO, MyTypeGroup, undefined>>())